...
CUDA_VISIBLE_DEVICES=2,3 python -m torch.distributed.launch --nproc_per_node 2 --master_port 29502 main.py --config config/release_iccv/latr_1000_baseline.py
